...
const testimonials = [
  {
    quote:
      "StyxFlow reduced our hiring time by 70%. The AI interviews are surprisingly accurate.",
    author: "Sarah Jenkins",
    role: "HR Director at TechCorp",
  },
  {
    quote:
      "I got a job offer within 2 days of uploading my resume. The process was seamless.",
    author: "Michael Chen",
    role: "Software Engineer",
  },
  {
    quote:
      "The candidate ranking system is a game changer. We only interview the top 5% now.",
    author: "David Lewis",
    role: "Founder, StartupX",
  },
  {
    quote:
      "Finally, a platform that understands technical skills without bias. Highly recommended.",
    author: "Elena Rodriguez",
    role: "VP of Engineering",
  },
  {
    quote:
      "The interface is beautiful and the AI feedback was actually helpful for my prep.",
    author: "James Wilson",
    role: "Product Manager",
  },
  {
    quote:
      "We filled our senior roles in record time. StyxFlow is the future of recruitment.",
    author: "Anita Patel",
    role: "Head of Talent",
  },
];
    ...
    <section ref={sectionRef} className="py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-6 mb-20 testimonial-header text-center">
        <h2 className="text-4xl md:text-6xl font-bold font-heading text-gray-900 mb-6">
          Loved by{" "}
          <span className="text-main font-mark font-light">Thousands</span>
        </h2>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto font-body">
          See what candidates and employers are saying about the future of
          hiring.
        </p>
      </div>
